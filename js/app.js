...
document.getElementById("form").addEventListener("submit", e => {
	...
	const tipCalculator = new TipCalculator(document.getElementById("bill-Amount").value, document.getElementById("service").value, document.getElementById("people").value);
